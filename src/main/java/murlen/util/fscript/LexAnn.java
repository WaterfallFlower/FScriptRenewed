...
final class LexAnn {
    ...
    private static final Hashtable<String, Integer> wordToken;
    ...
    public String toString() {
        ...
        return (!tokenName.equals("")) ? (tokenName + ":" + value) : ((char) ttype + ":" + value);
    }
     ...
     */
    private int getChar() {
        return (pos < length) ? line[pos++] : EOL;
    }
        ...
        while (ttype == 0) {
            ...
            switch (c) {
                ...
                case 'z':
                    ...
                    getNext = false;
                    value = new String(cBuf, 0, cPos);
                    Integer tt = wordToken.get(value);
                    if (tt != null) {
                        ttype = tt;
                    } else {
                        if (c == '(') {
    ...
    static {
        ...
        wordToken.put("double", TT_DEFDOUBLE);
        wordToken.put("object", TT_DEFOBJECT);
        wordToken.put("null", TT_NULL);
    }
}
